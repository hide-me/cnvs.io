    ...
    <div class="container d-flex justify-content-center px-0">
        <div class="col-md-10 px-0">
            <nav class="navbar navbar-light justify-content-between flex-nowrap flex-row">
                ...
                <a href="{{ sprintf('https://github.com/cnvs/canvas/releases/tag/%s', $latest_release) }}" class="ml-auto mr-3 font-weight-bold" target="_blank" rel="noopener" aria-label="Latest release">
                    {{ $latest_release }}
                </a>
                <a href="https://github.com/cnvs/canvas" target="_blank" rel="noopener" aria-label="View on GitHub">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10 mt-4">
                ...
                <p class="text-secondary text-center pt-3">Web native: Fully mobile and desktop ready on any device</p>
            </div>
            ...
            <div class="col-lg-10 text-center">
                <div class="row justify-content-around py-5">
                    <div class="col-lg-4 text-left my-auto">
                        ...
                        <p>Measure the impact of your posts with realtime data. Not everyone needs the headache of setting up Google Analytics, so we built-in just the best parts, and added a couple new ones.</p>
                    </div>
            ...
            <div class="col-lg-10 text-center">
                <div class="row justify-content-around py-5">
                    <div class="col-lg-4 text-left my-auto">
                        ...
                        <p>Ensure your content is optimized with fully customizable meta data for Facebook and Twitter sharing cards, as well as tags and topics to group your posts by.</p>
                    </div>
                    <div class="col-lg-6 my-auto order-lg-first">
...
<div class="container text-center my-5">
    <p>Released under the
        <a href="https://github.com/cnvs/canvas/blob/master/license" class="font-weight-bold" target="_blank" rel="noopener">MIT</a> license.
        <a href="https://github.com/cnvs/canvas" class="font-weight-bold" target="_blank" rel="noopener">View source</a>.
    </p>
    <p>Proudly hosted and sponsored by
