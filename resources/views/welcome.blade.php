...
@section('title', 'Not just another blog')

@section('content')
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1>Never judge a book by it's cover</h1>
            <p class="lead font-weight-normal">As you may have noticed, things are amiss. Canvas v4.0 is in development, and it'll be the best one yet.</p>
