<nav class="navbar navbar-transparent navbar-fixed-top navbar-color-on-scroll">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}"><img src="https://cdn.cnvs.io/assets/img/logo.png" alt="Canvas Logo" id="navbar-logo"></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="tt-navigation">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="https://github.com/cnvs/canvas" target="_blank" data-original-title="GitHub">
                        <i class="fa fa-github"></i>
                    </a>
                </li>
                <li>
                    <a href="https://twitter.com/cnvs_io" target="_blank" data-original-title="Twitter">
